...
public class Login extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		loginTitle.setText(fetchStringConfig("Text", "LOGIN_TITLE"));
		...
		jButtonSwitchToRegistration.setText(fetchStringConfig("Text", "LOGIN_SWITCH_TO_REGISTRATION"));
		...
		jButtonLogin.setText(fetchStringConfig("Text", "LOGIN_BUTTON_LOGIN"));
		...
		jButtonBack.setText(fetchStringConfig("Text", "LOGIN_BUTTON_BACK"));
		...
		jLabel1.setText(fetchStringConfig("Text", "LOGIN_LABEL_USERNAME_OR_EMAIL"));

		jLabel2.setText(fetchStringConfig("Text", "LOGIN_LABEL_PASSWORD"));
