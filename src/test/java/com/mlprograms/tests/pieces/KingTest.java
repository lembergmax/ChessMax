...
class KingTest {
	...
	void testWhiteKingMoveUp() {
		...
		BOARD.loadPositionFromFen("8/8/8/8/4K3/8/8/8 w - - 0 1");
	...
	void testWhiteKingCannotMoveIntoCheck_Rook() {
		...
		BOARD.loadPositionFromFen("8/8/8/8/4K2r/8/8/8 w - - 0 1");
		King whiteKing = (King) BOARD.getPieceAt(4, 4);
	...
	void testWhiteKingCannotMoveIntoCheck_Bishop() {
		...
		BOARD.loadPositionFromFen("b7/8/8/8/4K3/8/8/8 w - - 0 1");
	...
	void testWhiteKingCannotMoveIntoCheck_Knight() {
		...
		BOARD.loadPositionFromFen("8/8/8/8/2n1K3/8/8/8 w - - 0 1");
		King whiteKing = (King) BOARD.getPieceAt(4, 4);
	...
	void testWhiteKingCheckByQueenDiagonal() {
		...
		BOARD.loadPositionFromFen("8/8/8/8/4K3/8/8/7q w - - 0 1");
		King whiteKing = (King) BOARD.getPieceAt(4, 4);
	...
	void testWhiteKingCheckmate() {
		...
		BOARD.loadPositionFromFen("Kb6/rqn5/8/8/8/8/8/8 w - - 0 1");
	...
	void testBlackKingMoveDown() {
		...
		BOARD.loadPositionFromFen("4k3/8/8/8/8/8/8/8 b - - 0 1");
	...
	void testBlackKingCheckmate() {
		...
		BOARD.loadPositionFromFen("kB6/RQN5/8/8/8/8/8/8 b - - 0 1");
